 ...
 * @author lm
 */
public class FormulariAviones extends javax.swing.JFrame {

    /**
     * Creates new form FormulariAviones
     */
    public FormulariAviones() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nombre", "Modelo", "Fabricante", "Capacidad", "Tipo Avion", "Estado Avion", "Avion Cargero", "Avion Combate"
            }
        ));
        jScrollPane1.setViewportView(jTable1);

        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 80, 640, 260));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormulariAviones.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormulariAviones().setVisible(true);
            }
        });
    }
